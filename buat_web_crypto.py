...
def build_standalone_web():
    try:
        ...
        <head>
            ...
            <title>BRI Crypto Monitor - Cuan Tiap Hari</title>
            <style>
        ...
        <body>
            <div class="header">
                ...
                <p>Pantau Harga & Mulai Investasi Sekarang</p>
            </div>
            <div class="container">
        """
        ...
        html_content += """
                ...
                <div class="footer">
                    Website ini dibuat secara otomatis melalui Termux oleh BRI | 2026
                </div>
            </div>
        </body>
        </html>
        ...
        print("[✅] Website + Tombol Cuan Berhasil Dibuat!")
